...
public class ViewMainDataClient implements Display{
    ...
    private JButton backSelectClient;

    public ViewMainDataClient(JPanel staticJPanel, DataClient dataClient, MyController controller) {
    ...
    public void display() {
        ...
        save = new JButton("Добавить нового клиента");
        save.setName("saveNewDataClient");
        save.addActionListener(controller);
        staticJPanel.add(save);

        backSelectClient = new JButton("Назад");
    ...
    private void fillDataAboutClient (){
        if(dataClient==null){
            staticJPanel.remove(backSelectClient);
